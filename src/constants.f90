...
!character(len=*), parameter :: sw_z = "Stellar"
 ...
 integer, parameter, dimension(3) :: l = [47, 36, 39] ! anharmonic osc.
!integer, parameter, dimension(3) :: l = [33, 26, 28] ! harmonic   osc.
...
! initial conditions ******************************
 real(WP), parameter :: Torr  = 133.322_WP   ! Torr
...
! exact the same steps of Matlab 
...
!                                     AA = [3e-17, 4e-16]       ! m^3/sec
 real(WP), parameter, dimension(2) :: AA = [8e-17_WP, 4e-16_WP] ! m^3/sec
