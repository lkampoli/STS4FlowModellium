...
! inputs  
 nn2i_b = y(1:l1)         ! vibrational levels N2
 no2i_b = y(l1+1:l1+l2)   ! vibrational levels O2
 nnoi_b = y(l1+l2+1:lall) ! vibrational levels NO
 nn_b   = y(lall+1)       ! N
 no_b   = y(lall+2)       ! O 
 v_b    = y(lall+3)       ! velocity
 T_b    = y(lall+4)       ! temperature
...
!temp   = T_b !depending on dimensions of Y0_bar
 temp   = T_b*T0
...
! write(*,*) "call compute_VV'(temp)"
 ...
 do i1=1,l1 ! for all vibrational levels of N2
 ...
 do i2=1,l2 ! for all vibrational levels of O2
 ...
 do i3=1,l3 ! for all vibrational levels of NO
...
!dy = matmul(Ainv, Brhs)
 ...
 subroutine compute_rhs(neq, y, RHS)
